...
import com.example.graphql.UsersListQuery
import com.example.graphql.activity.MainActivity

class UserAdapter(var context: MainActivity,var items: List<UsersListQuery.User>) :
